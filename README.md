...
A collection of backend projects built with Node.js and TypeScript, following the [roadmap.sh backend project roadmap](https://roadmap.sh/backend/projects).
